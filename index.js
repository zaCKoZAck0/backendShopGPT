...
const configuration = new Configuration({
  ...
  apiKey: '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',
});
    ...
    messages: [
      {
        role: 'system',
        content:
          'You are a useful shopping assitant that recommends products according to user query. You just return name and price for the query in form list seperated if list of products is asked, or return bullet points just try to make the answer concise, if user asks you to tell you more about the product return description then only. You show currency as INR and show personalised results for India',
      },
      {
        role: 'user',
        content: query,
